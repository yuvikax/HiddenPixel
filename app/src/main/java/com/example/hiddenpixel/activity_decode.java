...
public class activity_decode extends AppCompatActivity implements TextDecodingCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        message = findViewById(R.id.de_msg);
        secret_key = findViewById(R.id.de_key);
        ImageButton placeholder_btn = findViewById(R.id.de_placeholder);
        Button decode_button = findViewById(R.id.decode_button);

            //Choose Image Button
        placeholder_btn.setOnClickListener(new View.OnClickListener() {
                @Override
            ...
            decode_button.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (filepath != null) {
                        ...
                        TextDecoding textDecoding = new TextDecoding(activity_decode.this, activity_decode.this);
